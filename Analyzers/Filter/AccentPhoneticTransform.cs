...
{
    /// <summary>
    /// Transformation needed in order to transform the input of search for fuzzy and wildcard seaches 
    /// when documents are analysed with a GreekACIAnalyzer 
    /// </summary>
    public class AccentPhoneticTransform : ITransform
    {
        /// <summary>
        ...
        public int PhoneticTransform(char[] output, char[] input, int length)
        {
